...
## Response style
- No preamble or "here's what I did" narration, No summaries at the end of responses
- Prose over bullet lists unless structure is genuinely needed, Shortest correct answer; don't over-explain
- Skip affirmations ("Great question", "Sure!", etc.)